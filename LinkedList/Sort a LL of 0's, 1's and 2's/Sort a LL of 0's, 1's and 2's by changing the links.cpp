...
// node, we attach it to the end of its corresponding list. Finally, we link all three lists. 
// To avoid many null checks, we use three dummy pointers zeroD, oneD and twoD that work as dummy 
// headers of three lists.
